...
to the repository: https://github.com/shkodm/precice_st_output.
...
if __name__ == "__main__":
    ...
    # Clone repository.
    ccall("git clone https://github.com/shkodm/precice_st_output")
    ...
    if not args.success:
        ...
        if args.branch:
            ...
            ccall("git commit -m \"Output == Reference, build number: ${TRAVIS_BUILD_NUMBER} \" -m \"Build url: ${TRAVIS_JOB_WEB_URL}\"")
    ccall("git remote set-url origin https://${GH_TOKEN}@github.com/shkodm/precice_st_output.git > /dev/null 2>&1")
    ccall("git push")
